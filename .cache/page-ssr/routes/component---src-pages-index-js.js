...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5472);
...
// EXTERNAL MODULE: external "/Users/veronica.lee/Portfolio/vl-portfolio-minimal/node_modules/react/index.js"
var index_js_ = __webpack_require__(5472);
...
function Icon(props){switch(props.name.toLowerCase()){case'external':return/*#__PURE__*/index_js_default().createElement(IconExternal,{color:props.color});case'behance':return/*#__PURE__*/index_js_default().createElement(IconBehance,{color:props.color});case'github':return/*#__PURE__*/index_js_default().createElement(IconGithub,{color:props.color});case'linkedin':return/*#__PURE__*/index_js_default().createElement(IconLinkedIn,{color:props.color});case'mail':return/*#__PURE__*/index_js_default().createElement(IconMail,{color:props.color});case'medium':return/*#__PURE__*/index_js_default().createElement(IconMedium,{color:props.color});case'twitter':return/*#__PURE__*/index_js_default().createElement(IconTwitter,{color:props.color});case'hashnode':return/*#__PURE__*/index_js_default().createElement(IconHashnode,{color:props.color});default:return null;}}
...
const shownProfiles=props.from.map(profile=>{const normalizedProfileId=profile.toLowerCase();if(Object.values(SocialProfile).includes(normalizedProfileId)){return{id:normalizedProfileId,label:socialProfileLabels[normalizedProfileId],url:siteMetadata.social[normalizedProfileId]};}else{throw new Error(`Unknown social profile ${profile}.`);}});return/*#__PURE__*/index_js_default().createElement(components_Slider/* Slider */.i,null,shownProfiles.map((profile,key)=>{const completeProfileData=profile.label&&profile.url;return!completeProfileData?null:/*#__PURE__*/index_js_default().createElement("a",{key:key,className:Profile,href:profile.url,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":profile.label,style:props.showIcon?{padding:'0.5rem 1.25rem'}:undefined},props.showIcon?/*#__PURE__*/index_js_default().createElement(Icon,{name:profile.id}):undefined," ",profile.label);}));}
...
function InterestsSection(props){var _data$button$initiall;const response=Interests_data_useLocalDataSource();const data=response.allInterestsJson.sections[0];const shouldShowButton=data.button.visible!==false;const initiallyShownInterests=(_data$button$initiall=data.button.initiallyShownInterests)!==null&&_data$button$initiall!==void 0?_data$button$initiall:5;const[shownInterests,setShownInterests]=index_js_default().useState(shouldShowButton?initiallyShownInterests:data.interests.length);function loadMoreHandler(){setShownInterests(data.interests.length);}return/*#__PURE__*/index_js_default().createElement(components_Animation/* Animation */.f,{type:"fadeUp"},/*#__PURE__*/index_js_default().createElement(components_Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/index_js_default().createElement("div",{className:Interests},data.interests.slice(0,shownInterests).map((interest,key)=>{return/*#__PURE__*/index_js_default().createElement(components_Animation/* Animation */.f,{key:key,className:Interest,type:"scaleIn",delay:key*100},interest.image.src&&/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.HN,{image:interest.image.src.childImageSharp.gatsbyImageData,className:style_module_Icon,alt:interest.image.alt||`Interest ${interest.label}`}),' ',interest.label);}),shouldShowButton&&shownInterests<data.interests.length&&/*#__PURE__*/index_js_default().createElement(components_Animation/* Animation */.f,{type:"scaleIn",delay:(shownInterests+1)*100},/*#__PURE__*/index_js_default().createElement(Button/* Button */.z,{type:Button/* ButtonType.BUTTON */.L.BUTTON,onClickHandler:loadMoreHandler,label:data.button.label})))));}
...
function ProjectsSection(props){const response=Projects_data_useLocalDataSource();const data=response.allProjectsJson.sections[0];return/*#__PURE__*/index_js_default().createElement(components_Animation/* Animation */.f,{type:"fadeIn"},/*#__PURE__*/index_js_default().createElement(components_Section/* Section */.$,{anchor:props.sectionId,heading:props.heading},/*#__PURE__*/index_js_default().createElement(components_Slider/* Slider */.i,{additionalClasses:[Projects]},data.projects.map((project,key)=>{return project.visible?/*#__PURE__*/index_js_default().createElement(Project_Project,{key:key,index:key,data:project}):null;})),data.button!==undefined&&data.button.visible!==false&&/*#__PURE__*/index_js_default().createElement(components_Animation/* Animation */.f,{className:MoreProjects,type:"fadeIn"},/*#__PURE__*/index_js_default().createElement(Button/* Button */.z,{type:Button/* ButtonType.LINK */.L.LINK,externalLink:true,url:data.button.url,label:data.button.label}))));}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5472);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4646);
function IndexPage(){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .Seo */ .pQ,{title:"Veronica Lee"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .Page */ .T3,{useSplashScreenAnimation:true},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .HeroSection */ .DH,{sectionId:"hero"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .AboutSection */ .ez,{sectionId:"about",heading:"About Veronica"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .InterestsSection */ .aS,{sectionId:"details",heading:"Favorite Tools"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .ProjectsSection */ .Au,{sectionId:"features",heading:"Projects"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_theme_portfolio_minimal__WEBPACK_IMPORTED_MODULE_1__/* .ContactSection */ .U0,{sectionId:"github",heading:"Contact"})));}
...
!(function () {
  ...
  !(function () {
    ...
    const e = __webpack_require__(5472);
    var t = n.n(e),
      r = n(697),
      i = n.n(r),
      c = n(808),
